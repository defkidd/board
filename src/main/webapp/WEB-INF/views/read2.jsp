		...
		<body>
			...
			<div class="modal">
				<div class="modal_body">
					...
					<br>
					<input type="hidden" name="boardNum" value="${detail.boardNum }">
					<input type="hidden" id="id_replyNo" value="">
			...
			<script type="text/javascript">
				...
				const f_detailDel = () => {
					let replyNo = document.querySelector("#id_replyNo").value;
					console.log(replyNo);
					const xhr = new XMLHttpRequest();
				...
				const f_detail = () => {
					...
					// console.log(event.target.querySelector(".replyNo").value);
					document.querySelector("#id_replyNo").value = event.target.querySelector(".replyNo").value;
				...
				c_replyList.addEventListener("click", f_detail);
				...
				// 			detailWriter.value = values[1];
				// 			detailContent.value = values[2];
				// 			document.querySelector("#id_replyNo").value = p_list[i].querySelector(".replyNo").value;
				// 			modal.classList.toggle('show');
				...
				// 				if (event.target.id === "detailDel") {
				// 					f_detailDel(document.querySelector("#id_replyNo").value);
				// 				}
				// 			})
				// 			// detailMod.addEventListener("click", f_detailMod.bind(this, event.target.lastChild.value));

				// 			// detailDel.addEventListener("click", f_detailDel.bind(this, document.querySelector("#id_replyNo").value));
				// 		};
